...
import { EUROPE_OTHERS_COUNTRIES } from "@/data/site";
...
export const Route = createFileRoute("/countries/europe-others/$country")({
  loader: ({ params }) => {
    const country = EUROPE_OTHERS_COUNTRIES.find((c) => c.slug === params.country);
