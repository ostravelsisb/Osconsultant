...
export const DESTINATIONS: Destination[] = [
  {
    ...
    generalRequirements: [
      ...
      "Visa Fee: 90 EUR (Standard Adult)",
    ...
    visas: [
      {
        ...
        requirements: [
          ...
          "DS-160 Form requirements: Personal, Family, and Work details",
          "Education history (Matriculation to highest degree)",
          "Travel history for the last 5 years",
          "Social media identifiers (if applicable)",
          "Information about your host/sponsor in the US",
          "Bank Statement (Last 6 months recommended)",
  ...
  },
  {
    ...
    generalRequirements: [
      ...
      "Visa Fee: £135 (Standard Visitor - up to 6 months)",
      "Proof of funds (Bank statements for 6 months)",
      "Proof of accommodation in the UK",
      "TB Test Certificate (if staying over 6 months)",
    ],
    stepByStep: [
      {
    ...
    visas: [
      {
        ...
        requirements: [
          ...
          "6 Months Bank Statement (Signed and stamped)",
          "Account Maintenance Certificate",
          "Last 3 Years Tax Returns (FBR)",
          "Salary Slips (Last 3 months) or Business Proof",
          "Family Registration Certificate (FRC)",
          "Property/Asset documents in Pakistan",
          "Confirmed Hotel Booking & Flight Itinerary",
  ...
  },
  {
    ...
    generalRequirements: [
      "Valid Passport",
      "Visa Fee: $100 CAD + Biometrics: $85 CAD",
    ...
    visas: [
      {
        ...
        requirements: [
          "Original Passport and digital copies",
          "Digital Photographs (as per IRCC specs)",
          "6 Months Bank Statement (Closing balance matters)",
          "Employment Letter & Salary Slips",
          "Family Registration Certificate (FRC)",
          "Strong Statement of Purpose (SOP)",
          "Travel History (if any)",
          "Proof of Assets (Property, etc.)",
        ],
